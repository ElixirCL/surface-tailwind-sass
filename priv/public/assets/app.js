...
`, template.innerHTML.trim());
  ...
  var LiveSocket = class {
    ...
    getHookCallbacks(name) {
      return name && name.startsWith("Phoenix.") ? hooks_default2[name.split(".")[1]] : this.hooks[name];
    }
    isUnloaded() {
  ...
  var liveSocket = new LiveSocket("/live", Socket, { hooks: hooks_default, params: { _csrf_token: csrfToken } });
